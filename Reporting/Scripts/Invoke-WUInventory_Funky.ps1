...
$AzureFunctionURL = "https://oshrcazclouldlapsfunction.azurewebsites.net/api/LogCollectorAPI" #e.g. "https://myfunctionappnamegoeshere.azurewebsites.net/api/LogCollectorAPI"
